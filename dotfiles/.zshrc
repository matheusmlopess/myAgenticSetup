...
#ZSH_THEME="agnoster"
#ZSH_THEME="amuse"
#"robbyrussell"	"agnoster" "amuse" "aussiegeek" "bira"
ZSH_THEME="random"
...
ZSH_THEME_RANDOM_CANDIDATES=( "robbyrussell" "agnoster" "amuse" "aussiegeek" "bira" )
...
test_web_run() {
  cd ~/repo/PB_updgrader/PB-TC-delivery-workspace || return 1
  (cd specDD/arch-viewer && npm run dev) &
  (cd specDD/docs-viewer && npm run dev) &
  wait
}
alias test-web='test_web_run'
